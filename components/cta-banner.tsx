    ...
    <section className="py-20 gradient-brand">
      <div className="container mx-auto px-4 text-center">
        ...
        >
          ...
          >
            {[
              { title: t.cta.features.free.title, subtitle: t.cta.features.free.subtitle },
              { title: t.cta.features.secure.title, subtitle: t.cta.features.secure.subtitle },
              { title: t.cta.features.fast.title, subtitle: t.cta.features.fast.subtitle },
              { title: t.cta.features.support.title, subtitle: t.cta.features.support.subtitle }
            ].map((item, index) => (
              <motion.div
                key={index}

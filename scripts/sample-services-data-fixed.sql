-- Sample Services Data for ZedyoumPlus (Fixed with real passwords)
-- This script adds sample data for testing the services system

-- First, let's add some sample users (sellers) with real password hashes
-- Password for all test users: "password123"
INSERT INTO public.users (id, email, password_hash, role, created_at) VALUES
('11111111-1111-1111-1111-111111111111', 'seller1@example.com', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'seller', now()),
('22222222-2222-2222-2222-222222222222', 'seller2@example.com', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'seller', now()),
('33333333-3333-3333-3333-333333333333', 'buyer1@example.com', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'buyer', now())
